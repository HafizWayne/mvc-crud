...
<body>
    <div class="container mx-auto mt-10">
        ...
        <form:form method="post" action="${pageContext.request.contextPath}/admin/customers/update/${customer.id}" modelAttribute="customer"  class="w-full max-w-lg">
            <div class="mb-4">
            ...
            <div class="flex items-center justify-between">
                ...
                <a href="${pageContext.request.contextPath}/admin/customers" class="inline-block align-baseline font-bold text-sm text-blue-500 hover:text-blue-800">Cancel</a>
            </div>
        </form:form>
    </div>
</body>
